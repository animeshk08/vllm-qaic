...
def _query_server(base_url: str, model_name: str, prompt: str, max_tokens: int = 5) -> dict:
...
@pytest.mark.qaic_test_config(
    model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0", ctx_len=512, dtype="mxfp6", kv_dtype="mxint8"
)
